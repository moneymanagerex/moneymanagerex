...
===================================================================================
Microsoft Visual C++ 2015 Community compiler
-----------------------------------------------------------------------------------

NOTE:
    The directory msw-vc-2015 has the project files for:
...
1. Installation of the following:
   MS-VC 2015         https://www.visualstudio.com/en-us/downloads/download-visual-studio-vs.aspx
...
Compiling using Microsoft Visual C++ 2015 Community IDE
-----------------------------------------------------------------------------------
Note: wxWidgets must be built using MS VC++ 2015, to ensure a successful build.

1. Clone or download wxWidgets repository and switch to WX_3_0_BRANCH

2. Using MS VC++ 2015, select the project file in the wxWidgets folder.
   (.../build/msw/wx_vc12.sln)

   Using MS VC++ 2015, build the appropriate configurations for your needs.
   Recommended configurations for mmex: Release, Debug

3  Locate the directory: moneymanagerex\build\msw-vc-2015
   Open the project file: moneymanagerex\build\msw-vc-2015\mmex.sln
   MS VC++ 2015 will set up the project files to the user's environment.
...
5. Locate and Run the batch file: update_mmex_build_files.bat
   ...
   successfully run MMEX within the MS VC++ 2015 IDE.
...
----------|--------------------------|----------------------------------------------
WXWIN     | C:\CPP\wxWidgets         | Location of wxWidgets repository
