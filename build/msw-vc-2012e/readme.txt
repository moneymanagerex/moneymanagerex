...
===================================================================================
Microsoft Visual C++ 2012 Express compiler
-----------------------------------------------------------------------------------


NOTE:   The directory msw-vc-2012e has the project files for:
...
1. Installation of the following:
   MS-VC 2012e  http://www.microsoft.com/visualstudio/eng/downloads#d-2012-express
...
-----------------------------------------------------------------------------------
Note: When upgrading from MS VC++ 2010e to MS VC++ 2012e, wxWidgets must be rebuilt
      using MS VC++ 2012e, to ensure a successful build.

1. Ensure the prerequisites are complete with an installation of wxWidgets 2.9.4
   or greater, compiled using MS VC++ 2012e

2. Using MS VC++ 2012e, select the project file in the wxWidgets 2.9.4 folder.
   (.../wxWidgets-2.9.4/build/msw/wx_vc9.sln)

   This will allow MS VC++ 2012e to convert the appropriate existing project
   ...
   http://wiki.wxwidgets.org/Microsoft_Visual_C%2B%2B_Guide#Visual_Studio_C.2B.2B_2012

3  Locate the directory: mmex\build\msw-vc-2012e.
   Open the project file: mmex\build\msw-vc-2012e\mmex.sln
   MS VC++ 2012e will set up the project files to the user's environment.
...
5. Locate and Run the batch file: update_mmex_build_files.bat
   ...
   This will allow MS VC++ 2012e IDE to run mmex.exe successfully.
