...
enum EDocFile { F_CONTRIB = 0, F_LICENSE, HTML_INDEX, HTML_WEBAPP, HTML_CUSTOM_SQL, HTML_INVESTMENT, HTML_BUDGET, HTML_REPORTS, DOC_FILES_MAX };
wxString getPathDoc(EDocFile f, bool url = true);

enum EResFile { TRANS_SOUND1 = 0, TRANS_SOUND2, HOME_PAGE_TEMPLATE, MMEX_LOGO, THEMESDIR, REPORTS, RES_FILES_MAX };
