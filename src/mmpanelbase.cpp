...
mmListCtrl::mmListCtrl(wxWindow *parent, wxWindowID winid)
    ...
    , attr1_(new wxListItemAttr(mmThemeMetaColour(meta::COLOR_LISTBORDER), mmThemeMetaColour(meta::COLOR_LISTALT0), wxNullFont))
    , attr2_(new wxListItemAttr(mmThemeMetaColour(meta::COLOR_LISTBORDER), wxNullColour, wxNullFont))
    , m_selected_row(-1)
    , m_selected_col(0)
    , m_asc(true)
    , m_ColumnHeaderNbr(-1)
