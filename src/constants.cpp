...
const wxString INIDB_ATTACHMENTS_FOLDER_DOCUMENTSDIR = "DOCSDIR";
const wxString INIDB_ATTACHMENTS_FOLDER_MMEXDIR = "MMEXDIR";
const wxString INIDB_ATTACHMENTS_FOLDER_DBDIR = "DBDIR";
const wxString DROPBOX = "%DROPBOX%";
const wxString USERPROFILE = "%USERPROFILE%";
const wxString APPDATA = "%APPDATA%";
