...
{
    wxDECLARE_DYNAMIC_CLASS(CategoryManager);
    wxDECLARE_EVENT_TABLE();

public:
    ~CategoryManager();
    CategoryManager();
    CategoryManager(wxWindow* parent
        , bool bIsSelection
        , int64 category_id);
...
inline int64 CategoryManager::getCategId() const { return m_categ_id; }
inline bool CategoryManager::getRefreshRequested() const { return m_refresh_requested; }
