    ...
    , m_hidden_trans_entry(false)
{
    if (transfer_entry)
    {
        ...
        m_asset = AssetModel::instance().get(transfer_entry->LINKRECORDID);
    }
...
void AssetDialog::OnOk(wxCommandEvent& /*event*/)
{
    ...
    AccountModel::Data* asset_account = AccountModel::instance().get(name);
