...
class MergeTagDialog : public wxDialog
{
    wxDECLARE_DYNAMIC_CLASS(MergeTagDialog);

public:
    MergeTagDialog();
    ~MergeTagDialog();
    MergeTagDialog(wxWindow* parent, int64 source_tag_id = -1);
...
inline int MergeTagDialog::updatedTagsCount() const { return m_changed_records; }
