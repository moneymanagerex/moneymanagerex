...
wxIMPLEMENT_DYNAMIC_CLASS(DateRangeEditDialog, wxDialog);

wxBEGIN_EVENT_TABLE(DateRangeEditDialog, wxDialog)
  EVT_BUTTON(wxID_OK,      DateRangeEditDialog::OnOk)
  EVT_TEXT(TXT_CTRL_RANGE, DateRangeEditDialog::OnRange)
  EVT_CHOICE(CTRL_ANY,     DateRangeEditDialog::OnUpdateRangeFromControls)
wxEND_EVENT_TABLE()
...
DateRangeEditDialog::DateRangeEditDialog()
{
}

DateRangeEditDialog::DateRangeEditDialog(wxWindow* parent, wxString* name_ptr, wxString* range_ptr)
{
...
void DateRangeEditDialog::CreateControls()
{
...
void DateRangeEditDialog::OnRange(wxCommandEvent&)
{
    updateControlsFromRange(m_range_edit->GetValue());
    checkRange();
}

bool DateRangeEditDialog::checkRange() {
    bool rangeOk = false;
...
void DateRangeEditDialog::OnOk(wxCommandEvent&)
{
    wxString msg = "";
    bool saveIt = true;
...
void DateRangeEditDialog::OnUpdateRangeFromControls(wxCommandEvent&)
{
...
void DateRangeEditDialog::updateControlsFromRange(wxString range)
{
...
void DateRangeEditDialog::showSelectControls(bool status)
{
