...
class TransactionUpdateDialog : public wxDialog
{
    wxDECLARE_DYNAMIC_CLASS(TransactionUpdateDialog);
    wxDECLARE_EVENT_TABLE();

public:
    TransactionUpdateDialog();
    ~TransactionUpdateDialog();
    TransactionUpdateDialog(wxWindow* parent, std::vector<int64>& transaction_id);
