...
public:
    ...
    int mmIsRecordMatches(const TrxData &tran
        , const TrxSplitModel::DataA& splits);
    int mmIsRecordMatches(const TrxData &tran
        , const std::map<int64, TrxSplitModel::DataA>& splits);
    int mmIsRecordMatches(const SchedData &tran
...
inline const wxString TrxFilterDialog::mmGetBeginDate() const { return m_begin_date; }
...
inline bool TrxFilterDialog::mmIsDateRangeChecked() const { return m_use_date_filter && dateRangeCheckBox_->GetValue(); }
inline bool TrxFilterDialog::mmIsRangeChecked() const { return m_use_date_filter && datesCheckBox_->IsChecked(); }
inline const wxString TrxFilterDialog::mmGetNumber() const { return transNumberEdit_->GetValue(); }
inline const wxString TrxFilterDialog::mmGetNotes() const { return notesEdit_->GetValue(); }
inline bool TrxFilterDialog::mmIsHideColumnsChecked() const { return showColumnsCheckBox_->IsChecked(); }
inline bool TrxFilterDialog::mmIsTypeChecked() const { return typeCheckBox_->IsChecked(); }
inline bool TrxFilterDialog::mmIsPayeeChecked() const { return payeeCheckBox_->IsChecked(); }
inline bool TrxFilterDialog::mmIsNumberChecked() const { return transNumberCheckBox_->IsChecked(); }
inline bool TrxFilterDialog::mmIsNotesChecked() const { return notesCheckBox_->IsChecked(); }
inline bool TrxFilterDialog::mmIsColorChecked() const { return colorCheckBox_->IsChecked(); }
inline bool TrxFilterDialog::mmIsCategoryChecked() const { return categoryCheckBox_->IsChecked(); }
inline bool TrxFilterDialog::mmIsCategorySubCatChecked() const { return categorySubCatCheckBox_->IsChecked(); }
inline bool TrxFilterDialog::mmIsStatusChecked() const { return statusCheckBox_->IsChecked(); }
inline const wxString TrxFilterDialog::mmGetLabelString() const { return  m_setting_name->GetStringSelection(); }
