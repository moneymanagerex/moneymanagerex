...
{
    wxDECLARE_DYNAMIC_CLASS(MergePayeeDialog);

public:
    MergePayeeDialog();
    ~MergePayeeDialog();
    MergePayeeDialog(wxWindow* parent, int64 source_payee_id = -1);
...
inline int MergePayeeDialog::updatedPayeesCount() const { return m_changed_records; }
