...
wxIMPLEMENT_DYNAMIC_CLASS(BudgetYearEntryDialog, wxDialog);

wxBEGIN_EVENT_TABLE( BudgetYearEntryDialog, wxDialog )
    EVT_BUTTON(wxID_OK, BudgetYearEntryDialog::OnOk)
wxEND_EVENT_TABLE()

BudgetYearEntryDialog::BudgetYearEntryDialog() 
{
}

BudgetYearEntryDialog::BudgetYearEntryDialog(wxWindow* parent
    , bool withMonth)
{
...
bool BudgetYearEntryDialog::Create(wxWindow* parent, wxWindowID id
...
void BudgetYearEntryDialog::CreateControls()
{
...
void BudgetYearEntryDialog::OnOk(wxCommandEvent& /*event*/)
{
