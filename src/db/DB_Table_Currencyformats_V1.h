 ...
 *
 *      Revision History:
 *          AUTO GENERATED at 2025-10-30 10:03:48.369936.
 *          DO NOT EDIT!
 */
//=============================================================================
#pragma once
...
struct DB_Table_CURRENCYFORMATS_V1 : public DB_Table
{
    ...
    void ensure_data(wxSQLite3Database* db)
    {
        ...
        db->ExecuteUpdate(wxString::Format("INSERT INTO CURRENCYFORMATS_V1 VALUES ('64', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '1', '1', '%s', '%s')", _("Hungarian forint"), L"", L"Ft", L".", L" ", L"", L"", L"HUF", L"Fiat"));
