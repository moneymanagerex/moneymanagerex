 ...
 *
 *      Revision History:
 *          AUTO GENERATED at 2018-04-16 12:56:27.892088.
 *          DO NOT EDIT!
 */
//=============================================================================
...
struct DB_Table_CURRENCYFORMATS_V1 : public DB_Table
{
    ...
    void ensure_data(wxSQLite3Database* db)
    {
        ...
        db->ExecuteUpdate(wxString::Format("INSERT INTO CURRENCYFORMATS_V1 VALUES ('3', '%s', '%s', '', '.', ' ', '100', '1', 'GBP', 'Traditional')", wxTRANSLATE("UK Pound"), L"£"));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CURRENCYFORMATS_V1 VALUES ('4', '%s', '', '%s', ',', ' ', '100', '1', 'RUB', 'Traditional')", wxTRANSLATE("Russian Ruble"), L"р"));
        ...
        db->ExecuteUpdate(wxString::Format("INSERT INTO CURRENCYFORMATS_V1 VALUES ('6', '%s', '%s', '', '.', ' ', '100', '1', 'AFN', 'Traditional')", wxTRANSLATE("Afghan afghani"), L"؋"));
        ...
        db->ExecuteUpdate(wxString::Format("INSERT INTO CURRENCYFORMATS_V1 VALUES ('9', '%s', '', 'Kz', '.', ' ', '100', '1', 'AOA', 'Traditional')", wxTRANSLATE("Angolan kwanza")));
        ...
        db->ExecuteUpdate(wxString::Format("INSERT INTO CURRENCYFORMATS_V1 VALUES ('11', '%s', 'AR$', '', ',', '.', '100', '1', 'ARS', 'Traditional')", wxTRANSLATE("Argentine peso")));
        ...
        db->ExecuteUpdate(wxString::Format("INSERT INTO CURRENCYFORMATS_V1 VALUES ('115', '%s', '', '%s', ',', '.', '100', '1', 'PLN', 'Traditional')", wxTRANSLATE("Polish zloty"), L"zł"));
        ...
        db->ExecuteUpdate(wxString::Format("INSERT INTO CURRENCYFORMATS_V1 VALUES ('119', '%s', 'Db', '', '.', ' ', '0', '1', 'STD', 'Traditional')", L"São Tomé and Príncipe dobra"));
        ...
        db->ExecuteUpdate(wxString::Format("INSERT INTO CURRENCYFORMATS_V1 VALUES ('152', '%s', 'Bs.', '', '.', ',', '100', '1', 'VEF', 'Traditional')", L"Venezuelan Bolívar"));
    ...
    {
        query_ = "SELECT CURRENCYID, CURRENCYNAME, PFX_SYMBOL, SFX_SYMBOL, DECIMAL_POINT, GROUP_SEPARATOR, SCALE, BASECONVRATE, CURRENCY_SYMBOL, CURRENCY_TYPE FROM CURRENCYFORMATS_V1 ";
    }
    ...
    */
    bool save(Self::Data* entity, wxSQLite3Database* db)
    {
        ...
        {
            sql = "INSERT INTO CURRENCYFORMATS_V1(CURRENCYNAME, PFX_SYMBOL, SFX_SYMBOL, DECIMAL_POINT, GROUP_SEPARATOR, SCALE, BASECONVRATE, CURRENCY_SYMBOL, CURRENCY_TYPE) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)";
        }
        else
        {
            sql = "UPDATE CURRENCYFORMATS_V1 SET CURRENCYNAME = ?, PFX_SYMBOL = ?, SFX_SYMBOL = ?, DECIMAL_POINT = ?, GROUP_SEPARATOR = ?, SCALE = ?, BASECONVRATE = ?, CURRENCY_SYMBOL = ?, CURRENCY_TYPE = ? WHERE CURRENCYID = ?";
        }
