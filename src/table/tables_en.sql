...
CREATE INDEX IDX_BUDGETSEGMENT_BUDGETYEARID ON BUDGETSEGMENT_V1(BUDGETYEARID);
...
CREATE TABLE PLANASSUMPTIONGROUP_V1(
...
CREATE INDEX IDX_PLANASSUMPTIONGROUP_KIND ON PLANASSUMPTIONGROUP_V1(KIND);
CREATE INDEX IDX_PLANASSUMPTIONGROUP_SCOPEKEY ON PLANASSUMPTIONGROUP_V1(SCOPEKEY);

-- Describe PLANASSUMPTION_V1
CREATE TABLE PLANASSUMPTION_V1(
...
CREATE INDEX IDX_PLANASSUMPTION_KIND ON PLANASSUMPTION_V1(KIND);
CREATE INDEX IDX_PLANASSUMPTION_GROUPID ON PLANASSUMPTION_V1(GROUPID);

-- Describe PLANGROUP_V1
CREATE TABLE PLANGROUP_V1(
GROUPID integer primary key
, PARENTID integer
...
CREATE INDEX IDX_PLANGROUP_PARENTID ON PLANGROUP_V1(PARENTID);

-- Describe PLANITEM_V1
CREATE TABLE PLANITEM_V1(
...
, PRICEASSUMPTIONGROUPID integer
, TAXASSUMPTIONGROUPID integer
);
CREATE INDEX IDX_PLANITEM_GROUPID ON PLANITEM_V1(GROUPID);
CREATE INDEX IDX_PLANITEM_TARGETDATE ON PLANITEM_V1(TARGETDATE);
