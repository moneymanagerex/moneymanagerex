...
class ListBase : public wxListCtrl
{
protected:
...
public:
    ...
    const wxSharedPtr<wxListItemAttr> w_attr1, w_attr2; // style1, style2
...
private:
    ...
    auto getColOrderKey_v190() const -> const wxString;
    auto getColWidthKey_v190(int col_id) const -> const wxString;
    auto getSortColKey_v190(int i = 0) const -> const wxString;
    auto getSortAscKey_v190(int i = 0) const -> const wxString;
    void savePref_v190();
    void loadPref_v190();
...
protected:
    // override wxListCtrl
    virtual auto OnGetItemAttr(long row) const -> wxListItemAttr* override;
...
inline int ListBase::getColNrSize() const
{
...
inline bool ListBase::isValidColId(int col_id) const
{
    return (col_id >= 0 && col_id < getColIdSize());
}

inline bool ListBase::isValidColNr(int col_nr) const
{
    return (col_nr >= 0 && col_nr < getColNrSize());
}

inline int ListBase::getColId_Nr(int col_nr) const
{
    return m_col_id_nr.empty() ? col_nr : m_col_id_nr[col_nr];
}

inline int ListBase::getColNr_Id(int col_id) const
{
    return m_col_id_nr.empty() ? col_id :
        std::find(m_col_id_nr.begin(), m_col_id_nr.end(), col_id) - m_col_id_nr.begin();
}

inline int ListBase::getColNr_Vo(int col_vo) const
{
...
inline int ListBase::getColVo_Nr(int col_nr) const
{
...
inline int ListBase::getColId_Vo(int col_vo) const
{
...
inline bool ListBase::isHiddenColNr(int col_nr) const
{
    return isHiddenColId(getColId_Nr(col_nr));
}

inline bool ListBase::isHiddenColVo(int col_vo) const
{
    return isHiddenColId(getColId_Vo(col_vo));
}

inline int ListBase::getSortColId(int i) const
{
    return m_sort_col_id[i];
}

inline int ListBase::getSortColNr(int i)
{
...
inline bool ListBase::getSortAsc(int i) const
{
    return m_sort_asc[i];
}

inline const wxString ListBase::getColOrderKey_v190() const
{
    return o_col_order_prefix + "_COLUMNORDER";
}

inline const wxString ListBase::getColWidthKey_v190(int col_id) const
{
    return wxString::Format(o_col_width_prefix + "%d_WIDTH", col_id);
}

inline const wxString ListBase::getSortColKey_v190(int i) const
{
    return wxString::Format("%s_SORT_COL%s", o_sort_prefix, (i == 1 ? "2" : ""));
}

inline const wxString ListBase::getSortAscKey_v190(int i) const
{
