    ...
    m_static_dialog(false)
{
    ...
    m_currency_id = currencyID == -1 ? Option::instance().getBaseCurrency() : currencyID;
...
void mmMainCurrencyDialog::fillControls()
{
    ...
    int baseCurrencyID = Option::instance().getBaseCurrency();
...
{
    int baseCurrencyOLD = Option::instance().getBaseCurrency();
