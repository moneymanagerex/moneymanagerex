...
DashboardPref::DashboardPref()
{
    ...
    int sel_id = PrefModel::instance().getHomePageIncExpRange();
...
DashboardPref::DashboardPref(wxWindow *parent
    , wxWindowID id
    , const wxPoint &pos
    , const wxSize &size
    , long style, const wxString &name) : DashboardPref()
{
...
const wxSharedPtr<mmDateRange> DashboardPref::get_inc_vs_exp_date_range() const
{
