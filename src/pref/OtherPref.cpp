...
OtherPref::OtherPref(wxWindow *parent
    , wxWindowID id
    , const wxPoint &pos
    , const wxSize &size
...
void OtherPref::Create()
{
    ...
    m_asset_compounding->SetSelection(PrefModel::instance().getAssetCompounding());
    ...
    m_store_account_specific_filter->SetValue(PrefModel::instance().getUsePerAccountFilter());
