...
void relocatePayeeDialog::CreateControls()
{
    ...
    cbSourcePayee_ = new wxComboBox(this, wxID_BOTTOM
        ...
        , Model_Payee::instance().all_payee_names(true));
    cbSourcePayee_->AutoComplete(Model_Payee::instance().all_payee_names(true));
...
void relocatePayeeDialog::OnOk(wxCommandEvent& /*event*/)
{
    ...
    if (ans == wxOK)
    {
        ...
        if (empty != wxNOT_FOUND) cbSourcePayee_->Delete(empty);
