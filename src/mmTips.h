...
{
    wxTRANSLATE("Buying tip: Before going to a shop to buy something. Take the time making a list of what you really need. In the shop buy only what is on your list."),
    wxTRANSLATE("Buying tip: Cut back on subscriptions. Do you really need to subscribe to every streaming service? Are you using a paid service enough to justify the expense, or can you survive with the ad-supported free one? Do you need that monthly book club, or can you head to the library once per month instead?"),
    ...
    wxTRANSLATE("Get out of debt tip: Never endorse a loan. If the borrower—your friend, family member, significant other, whoever—misses payments, your credit score will take a plunge, the lender can come after you for the money, and it will likely destroy your relationship. Plus, if the bank is requiring a cosigner, the bank does not trust the person to make the payments."),
    ...
    wxTRANSLATE("MMEX tip: Always backup your .mmb database file regularly."),
    wxTRANSLATE("MMEX tip: Category Manager: Pressing 2 key combination will cycle through all categories starting with that key combination. Example: Pressing ho will select Homeneeds, Home, House Tax, etc…"),
    wxTRANSLATE("MMEX tip: Category Manager: Pressing the “H” key will cycle through all categories starting with the letter h."),
    wxTRANSLATE("MMEX tip: If upgrading to a new version of MMEX, make sure you backup your .mmb database file before doing so."),
    wxTRANSLATE("MMEX tip: MMEX supports printing of all reports that can be viewed. The print options are available under the menu, File → Print."),
    wxTRANSLATE("MMEX tip: Remember to make backups of your .mmb database file."),
    wxTRANSLATE("MMEX tip: Set exchange rate for currencies in case if you have accounts with different currencies."),
    wxTRANSLATE("MMEX tip: The .mmb database file is not encrypted. That means anyone else having the proper know how can actually open the file and read the contents. So make sure that if you are storing any sensitive financial information it is properly guarded."),
    wxTRANSLATE("MMEX tip: To mark a transaction as reconciled, select the transaction and press the “R” key. To mark a transaction as unreconciled, select the transaction and press the “U” key."),
    wxTRANSLATE("MMEX tip: To mark a transaction as requiring followup, select the transaction and press the “F” key."),
    wxTRANSLATE("MMEX tip: To print a statement with transactions from any arbitrary set of criteria, use the transaction filter to select the transactions you want and then do a print from the menu."),
    wxTRANSLATE("MMEX tip: Use copy (Ctrl+C) and paste (Ctrl+V) for frequently used transactions."),
    wxTRANSLATE("MMEX tip: You can modify some runtime behavior of MMEX by changing the settings in Options."),
