...
static const wxString TIPS [] =
{
    ...
    wxTRANSLATE("Tip: To mark a transaction as reconciled, select the transaction and press the 'r' or 'R' key. To mark a transaction as unreconciled, select the transaction and press the 'u' or 'U' key."),
    wxTRANSLATE("Tip: To mark a transaction as requiring followup, select the transaction and press the 'f' or 'F' key."),
