...
static const wxString TIPS [] =
{
    ...
    wxTRANSLATE("Tip: If the .mmb database file is unencrypted, anyone who has the knowledge can open the database file and read the contents. Ensure that any sensitive financial information stored is properly secured."),
    ...
    wxTRANSLATE("Grocery tip: Make a shopping list. A shopping list saves money by helping to avoid buying products that are not required. The simplest way is to track consumables as they are used. A magnetic notepad on the fridge can help to write down items that need to be bought."),
    ...
    wxTRANSLATE("Get out of debt tip: Create a realistic budget for the expenses."),
...
static const wxString STOCKTIPS[] = {
    ...
    wxTRANSLATE("Common mistake of investors: only buying known companies."),
    wxTRANSLATE("Common mistake of investors: only buying companies you like."),
    wxTRANSLATE("Common mistake of investors: only buying buzzworthy companies."),
