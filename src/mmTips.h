...
static const wxString TIPS [] =
{
    ...
    wxTRANSLATE("Tip: The .mmb database file is unencrypted. Anyone who has the knowledge can open the database file and read the contents. Ensure that any sensitive financial information stored is properly secured."),
