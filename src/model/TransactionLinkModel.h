...
public:
    /**
    Initialize the global TransactionLinkModel table on initial call.
    Resets the global table on subsequent calls.
    * Return the static instance address for TransactionLinkModel table
    * Note: Assigning the address to a local variable can destroy the instance.
    */
    static TransactionLinkModel& instance(wxSQLite3Database* db);

    /**
    * Return the static instance address for TransactionLinkModel table
    * Note: Assigning the address to a local variable can destroy the instance.
    */
    static TransactionLinkModel& instance();
