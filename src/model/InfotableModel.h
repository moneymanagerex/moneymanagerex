...
public:
    // Initialize the global InfotableModel table on initial call.
    // Resets the global table on subsequent calls.
    // Return the static instance address for InfotableModel table.
    // Note: Assigning the address to a local variable can destroy the instance.
    static InfotableModel& instance(wxSQLite3Database* db);

    // Return the static instance address for InfotableModel table.
    // Note: Assigning the address to a local variable can destroy the instance.
    static InfotableModel& instance();
