...
private:
    ...
    int m_trans_payee_none = PreferencesModel::NONE;              // TRANSACTION_PAYEE_NONE
    int m_trans_category_none = PreferencesModel::NONE;           // TRANSACTION_CATEGORY_NONE
    int m_trans_category_transfer_none = PreferencesModel::NONE;  // TRANSACTION_CATEGORY_TRANSFER_NONE
    int m_trans_status_reconciled = PreferencesModel::NONE;       // TRANSACTION_STATUS_RECONCILED
...
inline bool PreferencesModel::getDatabaseUpdated() const noexcept
{
    return m_database_updated;
}

inline const wxString& PreferencesModel::getLocaleName() const
{
    return m_locale_name;
}

inline const wxString PreferencesModel::getDateFormat() const
{
    return m_date_format;
}

inline const wxString& PreferencesModel::getUserName() const
{
    return m_user_name;
}

inline int64 PreferencesModel::getBaseCurrencyID() const noexcept
{
    return m_base_currency_id;
}

inline bool PreferencesModel::getUseCurrencyHistory() const noexcept
{
...
inline int PreferencesModel::getAssetCompounding() const noexcept
{
    return m_asset_compounding;
}

inline int PreferencesModel::getReportingFirstDay() const noexcept
{
    return m_reporting_first_day;
}

inline wxDateTime::WeekDay PreferencesModel::getReportingFirstWeekday() const noexcept
{
    return m_reporting_first_weekday;
}

inline int PreferencesModel::getFinancialFirstDay() const
{
    return m_financial_first_day;
}

inline wxDateTime::Month PreferencesModel::getFinancialFirstMonth() const {
    return m_financial_first_month;
}

inline int PreferencesModel::getBudgetDaysOffset() const noexcept
{
    return m_budget_days_offset;
}

inline int PreferencesModel::getHomePageIncExpRange() const noexcept
{
    return m_homepage_incexp_range;
}

inline int PreferencesModel::getIconSize() const noexcept
{
    return m_icon_size;
}

inline int PreferencesModel::getNavigationIconSize() const noexcept
{
    return m_navigation_icon_size;
}

inline int PreferencesModel::getToolbarIconSize() const noexcept
{
    return m_toolbar_icon_size;
}

inline int PreferencesModel::getTransCategoryNone() const noexcept
{
    return m_trans_category_none;
}

inline int PreferencesModel::getTransCategoryTransferNone() const noexcept
{
    return m_trans_category_transfer_none;
}

inline int PreferencesModel::getTransPayeeNone() const noexcept
{
    return m_trans_payee_none;
}

inline int PreferencesModel::getTransStatusReconciled() const noexcept
{
    return m_trans_status_reconciled;
}

inline int PreferencesModel::getTransDateDefault() const noexcept
{
    return m_trans_date_default;
}

inline bool PreferencesModel::getCheckNews() const noexcept
{
    return m_check_news;
}

inline bool PreferencesModel::getHideShareAccounts() const noexcept
{
    return m_hide_share_accounts;
}

inline bool PreferencesModel::getHideDeletedTransactions() const noexcept
{
    return m_hide_deleted_transactions;
}

inline bool PreferencesModel::getBudgetFinancialYears() const noexcept
{
    return m_budget_financial_years;
}

inline bool PreferencesModel::getBudgetIncludeTransfers() const noexcept
{
    return m_budget_include_transfers;
}

inline bool PreferencesModel::getBudgetSummaryWithoutCategories() const noexcept
{
    return m_budget_summary_without_categories;
}

inline bool PreferencesModel::UseTransDateTime() const noexcept
{
    return m_use_trans_datetime;
}

inline bool PreferencesModel::TreatDateAsSN() const noexcept
{
    return m_treat_date_as_SN;
}

inline bool PreferencesModel::getBudgetOverride() const noexcept
{
    return m_budget_override;
}

inline bool PreferencesModel::getBudgetDeductMonthly() const noexcept
{
    return m_budget_deduct_monthly;
}

inline int PreferencesModel::getThemeMode() const noexcept
{
    return m_theme_mode;
}

inline int PreferencesModel::getFontSize() const noexcept
{
    return m_font_size;
}

inline bool PreferencesModel::getSendUsageStats() const noexcept
{
    return m_send_usage_stats;
}

inline bool PreferencesModel::doSendUsageStats() const noexcept
{
#ifdef _DEBUG
    return false;
#else
...
inline bool PreferencesModel::getIgnoreFutureTransactions() const noexcept
{
    return m_ignore_future_transactions;
}

inline bool PreferencesModel::getIgnoreFutureTransactionsHomePage() const noexcept
{
    return m_ignore_future_transactions_home;
}

inline bool PreferencesModel::getDoNotColorFuture() const noexcept
{
    return m_do_not_color_future;
}

inline bool PreferencesModel::getDoSpecialColorReconciled() const noexcept
{
    return m_do_special_color_reconciled;
}

inline bool PreferencesModel::getUsePerAccountFilter() const noexcept
{
    return m_store_account_specific_filter;
}

inline bool PreferencesModel::getShowToolTips() const noexcept
{
    return m_show_tooltips;
}

inline bool PreferencesModel::getShowMoneyTips() const noexcept
{
    return m_show_moneytips;
}

inline const wxArrayString PreferencesModel::getCheckingRange() const noexcept
{
...
inline int PreferencesModel::getCheckingRangeM() const noexcept
{
    return m_checking_range_m;
}

inline const wxArrayString PreferencesModel::getReportingRange() const noexcept
{
...
inline int PreferencesModel::getReportingRangeM() const noexcept
{
    return m_reporting_range_m;
}

inline bool PreferencesModel::getShowNavigatorCashLedger() const noexcept
{
