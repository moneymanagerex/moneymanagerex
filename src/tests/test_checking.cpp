...
void Test_Checking::Test_Account_View_Savings()
{
    TestFrameBase* user_request = new TestFrameBase(m_base_frame);
    user_request->Show();
    ...
    CpuTimer* panel_timer = new CpuTimer("Account_View: Savings");
    ...
    wxMessageBox("Please examine Account View: NAB: Savings.\n\nContinue other tests ...",
        "Testing Account: Savings", wxOK, wxTheApp->GetTopWindow());
}

void Test_Checking::Test_Account_View_Mary()
{
    TestFrameBase* user_request = new TestFrameBase(m_base_frame);
    user_request->Show();
    ...
    // Anchor the panel. Otherwise it will disappear.
    wxMessageBox("Please examine Account View: Wallet: Mary.\n\nContinue other tests ...",
