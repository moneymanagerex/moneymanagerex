...
struct SorterByASSIGNMENTNAME
{ 
    template<class DATA>
    bool operator()(const DATA& x, const DATA& y)
    {
        return x.ASSIGNMENTNAME < y.ASSIGNMENTNAME;
    }
};
...
struct SorterByCONDITIONID
{ 
    template<class DATA>
    bool operator()(const DATA& x, const DATA& y)
    {
        return x.CONDITIONID < y.CONDITIONID;
    }
};

struct SorterByCONDITIONNAME
{ 
    template<class DATA>
    bool operator()(const DATA& x, const DATA& y)
    {
...
struct SorterByCRITERION
{ 
    template<class DATA>
    bool operator()(const DATA& x, const DATA& y)
    {
        return x.CRITERION < y.CRITERION;
    }
};
...
struct SorterByPAYEE_OVERWRITE_FLAG
{ 
    template<class DATA>
    bool operator()(const DATA& x, const DATA& y)
    {
        return x.PAYEE_OVERWRITE_FLAG < y.PAYEE_OVERWRITE_FLAG;
    }
};
...
struct SorterBySQLCODE
{ 
    template<class DATA>
    bool operator()(const DATA& x, const DATA& y)
    {
        return x.SQLCODE < y.SQLCODE;
    }
};
...
struct SorterBySUBCATEG_OVERWRITE_FLAG
{ 
    template<class DATA>
    bool operator()(const DATA& x, const DATA& y)
    {
        return x.SUBCATEG_OVERWRITE_FLAG < y.SUBCATEG_OVERWRITE_FLAG;
    }
};
