    ...
    <tr>
        <td>
            <img src="https://user-images.githubusercontent.com/17465872/233927369-03eabcaa-0e29-4730-8be0-462c3e1c9a01.png" 
                 alt="MMEX Dashboard (Linux Mint 21.1 Cinnamon)" 
                 title="MMEX Dashboard (Linux Mint 21.1 Cinnamon)">
        </td>
        <td>
            <img src="https://user-images.githubusercontent.com/17465872/233927379-268bd999-9093-4de9-ad72-02e0781b56ec.png" 
                 alt="MMEX Payee Report (Linux Mint 21.1 Cinnamon)" 
                 title="MMEX Payee Report (Linux Mint 21.1 Cinnamon)">
        </td>
    </tr>
    <tr>
        <td>
            <img src="https://user-images.githubusercontent.com/17465872/233927385-0f5a551f-494b-43b6-92ef-8fa1ba91e3ed.png" 
                 alt="MMEX Budget Setup (Linux Mint 21.1 Cinnamon)" 
                 title="MMEX Budget Setup (Linux Mint 21.1 Cinnamon)">
        </td>
        <td>
            <img src="https://user-images.githubusercontent.com/17465872/233927390-21a3bd99-06d7-4455-b96f-ae98b39a7358.png" 
                 alt="MMEX User Interface Language - Hungarian (magyar) (Linux Mint 21.1 Cinnamon)" 
                 title="MMEX User Interface Language - Hungarian (magyar) (Linux Mint 21.1 Cinnamon)">
        </td>
    </tr>
    <tr>
        <td>
            <img src="https://user-images.githubusercontent.com/17465872/233927396-7470f433-2756-4a68-b709-9a8834b6347d.png" 
                 alt="Organize Categories - unlimited nested multi-level category support (Linux Mint 21.1 Cinnamon)" 
                 title="Organize Categories - unlimited nested multi-level category support (Linux Mint 21.1 Cinnamon)">
        </td>
        <td>
            <img src="https://user-images.githubusercontent.com/17465872/233927401-597ea9bc-a890-44df-b6eb-d26ce8369551.png" 
                 alt="Transaction Filter (Linux Mint 21.1 Cinnamon)" 
                 title="Transaction Filter (Linux Mint 21.1 Cinnamon)">
        </td>
    </tr>
    <tr>
        <td>
            <img src="https://user-images.githubusercontent.com/17465872/233931375-051e7c9f-d4c4-4baa-9586-7ad10ef48aba.png" 
                 alt="MMEX Import from CSV file (Linux Mint 21.1 Cinnamon)" 
                 title="MMEX Import from CSV file (Linux Mint 21.1 Cinnamon)">
        </td>
        <td>
            <img src="https://user-images.githubusercontent.com/17465872/233931411-d7a92fed-272f-446d-b86a-89f99b66683a.png" 
                 alt="MMEX Import from QIF file (Linux Mint 21.1 Cinnamon)" 
                 title="MMEX Import from QIF file (Linux Mint 21.1 Cinnamon)">
        </td>
    <tr>
        <td>
            <img src="https://user-images.githubusercontent.com/17465872/233931435-825fa069-f182-4b50-970d-21755c90f1da.png" 
                 alt="MMEX Export as XML file (Linux Mint 21.1 Cinnamon)" 
                 title="MMEX Export as XML file (Linux Mint 21.1 Cinnamon)">
        </td>
        <td>
            <img src="https://user-images.githubusercontent.com/17465872/233931456-85f10a2f-c546-445e-966a-647d10919904.png" 
                 alt="MMEX Multi Currency Support (Linux Mint 21.1 Cinnamon)" 
                 title="MMEX Multi Currency Support (Linux Mint 21.1 Cinnamon)">
        </td>
    </tr>
</table>
