...
Current stable version that has been tested with MMEX is v3.3.2

1. Download Sources

        /bin/bash -c "$(curl -fsSL -O https://github.com/wxWidgets/wxWidgets/releases/download/v3.3.2/wxWidgets-3.3.2.tar.bz2)"
...
#### 4. Compile and Create Package
    ...
    -DwxWidgets_CONFIG_EXECUTABLE={PATH-TO-wxWidgets}/wxWidgets-3.3.2/build-cocoa/wx-config \
